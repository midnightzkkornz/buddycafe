...
final allCafes = <Cafe>[
  ...
  const Cafe(
    ...
    petc_location: 'Sukhothai Ave 99, Bond Street, Tambon Ban Mai, Pak Kret District, Nonthaburi 11120, Thailand'
  ),
  const Cafe(
    petc_id: 3, 
  ...
  const Cafe(
      ...
      petc_location: '582 Soi Sukhumvit 63 Road, Between Soi Ekamai 26,28 (Taiping Tower), Wattana, Bangkok, 10110, Thailand'
  ),
  const Cafe(
      petc_id: 7,
